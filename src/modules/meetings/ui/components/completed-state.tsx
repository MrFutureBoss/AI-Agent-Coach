    ...
    <div className="flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        <div className="bg-white rounded-lg border px-3">
          <ScrollArea>
            <TabsList className="p-0 bg-background justify-start rounded-nont h-13">
              <TabsTrigger
                value="summary"
                className="text-muted-foreground rounded-none bg-background 
                data-[state=active]:shadow-none border-b-2 border-transparent 
                data[state=active]:border-b-primary data-[state=active]:text-accent-foreground 
              ...
              <div>
                <Markdown
                  components={{
                    ...
                    p: (props) => (
                      <p
                        className="mb-6 leading-relaxed flex gap-x-1"
                        {...props}
                      />
                    ),
                    ul: (props) => (
